...
public class RecognitionCLI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Done.\n");
        /**
         * Initialize an instance of face encoder that will run on the CPU using the
         * model 9A (the one previously loaded by FaceLibrary.LoadModel()).
         * This instance has several parameters that can be set:
         * - ThreadCount : allocating more than 1 thread here can increase the speed of
         * the process.
         */
         ...
         * this score must be compared to a defined threshold.
         * It is recommended to select a threshold associated to at least an FMR of
         * 1:10000.
         ...
         * When using the SDK face matcher the id3FaceTemplateBufferType_Normal must be
         * used.
         */
        ...
        /**
         * When the face match will be performed on a smartcard then it is most likely
         * that
         * the templates must be sent to the smartcard either as BIT or BDT buffers.
         */

        /**
         * To enroll a template in a card, most implementations take a Biometric
         * Information Template (BIT) buffer as input.
         * This buffer can be prepared using the FaceTemplate.toBit() API.
         * Using this api require to set the desired matching threshold according to the
         * chosen face encoder.
         * To do so please refer to the documentation of the smartcard.
         * If you tell us which model of smartcard it is please know that id3 can also
         * provide support on this subject.
         */
        int matchingThreshold = 744; // Using threshold for FalseMatchRate 1/10k for id3 FaceEncoder 9A (from id3
                                     // GC452 documentation)
        byte referenceDataQualifier = 1;
        byte[] referenceTemplateBIT = faceTemplate1.toBit(matchingThreshold, referenceDataQualifier);

        /**
         * To verify a template in a card, most implementations take a Biometric
         * DataTemplate (BDT) buffer as input.
