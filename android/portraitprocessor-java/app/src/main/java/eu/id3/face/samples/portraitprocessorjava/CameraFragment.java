...
public class CameraFragment extends Fragment {
    ...
    private boolean needsToProcess = false;
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (isCapturing) {
                ...
                if (detectedFace != null) {
                    ...
                    needsToProcess = true;
                    if (needsToProcess) {
                        FaceProcessor.AnalyzeLargestFaceResult analyzeLargestFaceResult = faceProcessor.analyzeLargestFace(processingImage, detectedFace);
...
interface FaceProcessorListener {
    void onLargestFaceProcessed(FaceProcessor.AnalyzeLargestFaceResult analyzeLargestFaceResult);
}
