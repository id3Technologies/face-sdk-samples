...
public class CameraFragment extends Fragment {
    ...
    private MultipleBoundsView multipleBoundsView;
    ...
    public void onViewCreated(@NonNull final View view, Bundle savedInstanceState) {
        ...
        multipleBoundsView = view.findViewById(R.id.boundsView);
        multipleBoundsView.setPaints();
        multipleBoundsView.setWillNotDraw(false);
        multipleBoundsView.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    }

    /**
     * Sets the paint for bounds drawing.
     */
    void setBoundsPaints() {
        multipleBoundsView.setPaints();
    }
     ...
     */
    void stopCapture() {
        multipleBoundsView.update(null, 0, 0);
        isCapturing = false;
    }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                ...
                multipleBoundsView.setAspectRatio(previewSize.getWidth(), previewSize.getHeight());
            } else {
                cameraPreview.setAspectRatio(previewSize.getHeight(), previewSize.getWidth());
                multipleBoundsView.setAspectRatio(previewSize.getHeight(), previewSize.getWidth());
            }
    ...
    private final ImageReader.OnImageAvailableListener onImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (isCapturing) {
                ...
                /* Track faces and update bounds. */
                TrackedFaceList trackedFaceList = faceProcessor.trackFaces(processingImage);
                if (trackedFaceList != null) {
                    multipleBoundsView.update(trackedFaceList, processingImage.getWidth(), processingImage.getHeight());
                } else {
                    multipleBoundsView.update(null, 0, 0);
                }
