...
class CameraFragment : Fragment() {
        ...
        if (isCapturing) {
            ...
            if (detectedFace != null) {
                ...
                if (needsToEnrollTemplate) {
                    val enrollLargestFaceResult = faceProcessor!!.enrollLargestFace(processingImage, detectedFace)
                ...
                if (needsToVerifyTemplate) {
                    val verifyLargestFaceResult = faceProcessor!!.verifyLargestFace(processingImage, detectedFace)
    ...
    interface FaceProcessorListener {
        fun onLargestFaceEnrolled(enrollLargestFaceResult: FaceProcessor.EnrollLargestFaceResult)
        fun onLargestFaceVerified(verifyLargestFaceResult: FaceProcessor.VerifyLargestFaceResult)
    }
}
