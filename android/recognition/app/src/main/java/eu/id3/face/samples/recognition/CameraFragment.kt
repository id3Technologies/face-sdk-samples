        ...
        if (isCapturing) {
            ...
            if (detectedFace != null) {
                ...
                if (needsToEnrollTemplate) {
                    val enrollLargestFaceResult =
                        faceProcessor!!.enrollLargestFace(processingImage, detectedFace)
                ...
                if (needsToVerifyTemplate) {
                    val verifyLargestFaceResult =
                        faceProcessor!!.verifyLargestFace(processingImage, detectedFace)
