...
class CameraFragment : Fragment() {
    ...
    private lateinit var multipleBoundsView: MultipleBoundsView
    ...
    private fun openCamera(width: Int, height: Int) {
        ...
        try {
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                ...
                multipleBoundsView.setAspectRatio(previewSize.width, previewSize.height)
            } else {
                cameraPreview.setAspectRatio(previewSize.height, previewSize.width)
                multipleBoundsView.setAspectRatio(previewSize.height, previewSize.width)
            }
    ...
    private val onImageAvailableListener = OnImageAvailableListener { reader ->
        ...
        if (isCapturing) {
            ...
            val trackedFaceList = faceProcessor?.trackFaces(processingImage)
            if (trackedFaceList != null) {
                multipleBoundsView.update(
                    trackedFaceList,
